...
use Smartling\Vendor\Symfony\Component\ExpressionLanguage\Expression;
use Smartling\Vendor\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
...
EOF;
    ...
    private function getExpressionLanguage()
    {
        if (null === $this->expressionLanguage) {
            if (!class_exists('Smartling\Vendor\Symfony\Component\ExpressionLanguage\ExpressionLanguage')) {
